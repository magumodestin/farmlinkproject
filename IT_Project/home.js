...
const PRODUCTS = [
  ...
  {id:'dried-beans', name:'Sugar Beans', price:44, unit:'500g', category:'Grains & Cereals', location:'Mpumalanga', stock:40},
  ...
  {id:'watermelon', name:'Full Watermelon', price:40, unit:'each', category:'Fruits', location:'Northern Cape', stock:22},
  ...
  {id:'organic-spray', name:'Organic Pest Spray', price:209.99, unit:'5L', category:'Farm Inputs', location:'Gauteng', stock:30, badge:'Organic'},

  {id:'animal-feed', name:'Animal Feed', price:60, unit:'5kg', category:'Animal Feed', location:'Gauteng', stock:35},
  {id:'chicken-feed', name:'Layer Chicken Feed', price:88, unit:'5kg', category:'Animal Feed', location:'Gauteng', stock:40},
  ...
  {id:'charcoal', name:'Braai Charcoal', price:65, unit:'4kg', category:'Farm Goods', location:'Anywhere', stock:50},
...
const PRODUCT_PHOTO = {
  'boerewors': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSIK-aQW_FWbrc0uRAZ9a-HbtnslHi8KxG9fNgjl-ODzg&s',
  'beef-mince': 'https://commons.wikimedia.org/wiki/Special:FilePath/Ground%20Beef.jpg',
  'lamb-chops': 'https://c8.alamy.com/comp/2M7208W/raw-fresh-lamb-ribs-on-dark-background-close-up-raw-lamb-chops-rack-of-lamb-on-isolated-background-on-black-backdrop-2M7208W.jpg',
  'biltong': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbeLFTLvHbiDF1_KGqpfviiVFjGwzyNdC9JDTTqEMjSA&s=10',
  'pork-chops': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRctlJqxnJVW1hf3idgnNCpjCPM-Lty1m9_lyZzODOZLg&s=10',
  'chicken': 'https://c8.alamy.com/comp/2H3EAW9/raw-chicken-schnitzel-escalope-in-breadcrumbs-white-background-top-view-copy-space-2H3EAW9.jpg',
  'eggs': 'imgs/eggs.jpg',
  'free-range-eggs': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTusVxZ-4QCG9w1zilBnzAbCuH6IKdFRoG2Jmr4h8d-Bw&s=10',
  'quail-eggs': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTK2GnuWKV5FlVJ3RWtjm8lt9faiT8PrQ5tDrkGfsQkrw&s=10',
  'live-chickens': 'imgs/herns.jpg',
  'dairy': 'imgs/dairy.jpg',
  'cheese': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3EfxgySnWrcxQqyBTifHyanlyPNZ9gqdPGC_sLsnLVA&s=10',
  'yoghurt': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ5lszinJKbkLhRkHc_rTE5mnFmKJ9ioRuqgogR_MAP2Q&s=10',
  'butter': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUgxOOLY0crPP79JoJrSkfiiRkc2xhJGFjTnIaLKzEtw&s=10',
  'cream': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQLZy2o23KPbBSYJstrjFkHH4NImVTYGivyc8lLju9C9g&s=10',
  'amasi': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS5t-4cll6NjkPALLXcwNG8gUKCsUCSjryptCfnnqXpcA&s',
  ...
  'Brown Onions': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQDZ5F9e3e4qszWrNJ6Hx3y4CHEVH-tiRfkaTbdrpxKQw&s=10',
  'spinach': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTTkc9FxwWAfY5IEupdmfhotLJL4Qx182FsBIsyOE0vBQ&s=10',
  ...
  'sweet-potato': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSx3VUn7XpnJcjrcMkiD3m63X7ENwhbir37Ls4cSsgKlQ&s=10',
  'green-beans': 'https://images.unsplash.com/photo-1567375698348-5d9d5ae99de0',
  'cucumber': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQHXgTdh7aT9Bjo9dPbDeDUrOafbb179Jii_oIG-X1MA&s=10',
  ...
  'beetroot': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSckD7kZFi9SjE8eM3HEq4Ci77fyoVJzyK785UM63_nBw&s',
  'bananas': 'imgs/bananas.jpg',
  'apples': 'imgs/apples.jpeg',
  'oranges': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSksdZ8gob_W18mvKRGqVURJeQo-OG1dYDCF1jpPxGCRg&s=10',
  'naartjies': 'https://i.pinimg.com/736x/f8/16/c6/f816c6dba0770cca75c54fd4a23b5a06.jpg',
  'mangoes': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ79NfgiiZ-LJ5MzshzYZ0qUnVCvDptqAM88kDp3QbKKQ&s=10',
  'grapes': 'https://commons.wikimedia.org/wiki/Special:FilePath/Table_grapes_on_white.png',
  'watermelon': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQx4EZwIFao7x-aaabycoIZGKll-V4wflH3b6J5nVwj0g&s=10',
  'avocado': 'https://commons.wikimedia.org/wiki/Special:FilePath/Avocado_Hass_-_single_and_halved.jpg',
  'peaches': 'https://commons.wikimedia.org/wiki/Special:FilePath/Autumn_Red_peaches.jpg',
  'strawberries': 'https://commons.wikimedia.org/wiki/Special:FilePath/PerfectStrawberry.jpg',
  'maize': 'imgs/maize.jpg',
  'maize-meal': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRmrAvmMba8oNB4ZaKt3rtfIB4UORfL5ulCyAtMqzHqlA&s=10',
  'brown-rice': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTJXgW3ft3Pqc2B2yR45vNYs9wr58bjXesfERJZI6CYdg&s=10',
  'sorghum': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSiUZjlARD-SNSWJVsOLTvkZ2NoGE3bCKby8hU3BcUljA&s=10',
  'samp-beans': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTA9sW9hbtvGgxr5IJYV2DH9oAmVRMFGtWjtkfevlPONA&s=10',
  'wheat-flour': 'https://commons.wikimedia.org/wiki/Special:FilePath/Wheat_flour.jpg',
  'dried-beans': 'https://i.pinimg.com/736x/33/eb/99/33eb993fe1b114d7e5b2f5a6c93f0326.jpg',
  ...
  'mint': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRhD_pw5Dn72qfT7Fes0Ram82mvJsJV6Z3ZQ-sAthOGmw&s=10',
  'coriander': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbNNzjW4pZGkMMsB5tkqK84LDXwXq1RkOagWg4ll52Hw&s=10',
  'garlic': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-BhK4CK_xf060SK1cGJnuhdRlDhFmEX2GVkkyzqar0w&s=10',
  'ginger': 'https://i.pinimg.com/1200x/8e/b9/a4/8eb9a4f3745493f542dca43a8c0515ac.jpg',
  'chili': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTX944N3vQUcsvjtDBRLEBitzrWqJYGvRoOPZsXI5zP-Q&s=10',
  'honey': 'imgs/honey.jpg',
  'honeycomb': 'https://stingnaturals.co.za/wp-content/uploads/2024/11/10A0E686-B79D-4894-A887-EADC5F3506BA-600x600.png',
  'beeswax': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTq9M1kxIHNeQokYveR72v6L72ip81cNLj65geGW7pkzg&s=10',
  'nuts': 'https://i.pinimg.com/1200x/9b/1a/d6/9b1ad6f474104368105227421ed52e65.jpg',
  'peanuts': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRoD4SyGAVSxcNQt05lqtTPB9otQUklh1pdrXNsTIUk5Q&s',
  'sunflower-seeds': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ9PrJzUe9_Q89C128ntX3-5yxFJg1X7F8ObEsYhV9Jsg&s=10',
  'macadamia': 'https://commons.wikimedia.org/wiki/Special:FilePath/Macadamia_sawn_nutshell.jpg',
  'seedlings': 'https://i.pinimg.com/1200x/24/1d/f7/241df7f9111eb6c9482dc4fe4609e7e5.jpg',
  'herb-seedlings': 'https://i.pinimg.com/1200x/9e/41/e1/9e41e14a3c51de859bdbdf58d525a997.jpg',
  'fruit-saplings': 'imgs/fruit-saplings.jpg',
  'compost': 'https://images.unsplash.com/photo-1784285142743-71b20648d416?auto=format&fit=crop&fm=jpg&q=80&w=1200',
  'fertilizer': 'https://www.alshardware.co.za/cdn/shop/files/image_0603ea69-efd0-4bb1-b5d6-833796e2f22d.webp?v=1776350895&width=550',
  'seed-potatoes': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPlifMT5YTB-8yokrN7GbQAwP5NRwuns2VYu2MUL-3ta6evmasNgqDnqUK&s=10',
  'organic-spray': 'https://www.futurama.co.za/media/catalog/product/cache/ecd08c998766ed656774fbfdfeece653/s/a/sanot_san-o-agri_light_disinfectant_-_plant_care_5l.jpg',
  'chicken-feed': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS05FCOnYh8cLVL3ZoE9xlCyOLpydIxtOurQcsEkDYIiw&s',
  'lucerne': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSVZCPBrY675bf-IdkLEfvmFexI1B904N9yTRVxktcyGg&s=10',
  'animal-feed': 'https://i.pinimg.com/736x/f9/82/94/f982941c2cfc9df88ec80ee6cf1b580f.jpg',
  'firewood': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzbQFCp7kczOdieoUr0tGXPloA0R-Gi_LxBnLBdVW-ZQ&s=10',
  'charcoal': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT0-_Z463x5t_dRM4-8VCVtXMsEarF2daGs1AvSSe06sg&s=10',
  'raw-wool': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGgOOxaaNpdKrfFPFmd-Tw8VNpvS1lPWfcNBqZFs8Jkw&s=10',
  'flowers': 'https://m.media-amazon.com/images/I/6113P2f9P-L._AC_SY300_SX300_QL70_ML2_.jpg',
  'proteas': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSs2mMxFmkO4eXAFmizenMdTv7YvUqbfb5ZXVg_AbvVA&s=10',
  'potted-herbs': 'https://m.media-amazon.com/images/I/51+ga3wY6xL._AC_SY300_SX300_QL70_ML2_.jpg',
  'tractor-hire': 'https://commons.wikimedia.org/wiki/Special:FilePath/Farm_tractor.jpg',
  'ploughing': 'https://commons.wikimedia.org/wiki/Special:FilePath/Field%20Ploughing,%20Tigray%20(14424613203).jpg',
  'delivery': 'https://images.unsplash.com/photo-1542838132-92c53300491e',
  'cold-storage': 'https://commons.wikimedia.org/wiki/Special:FilePath/4C%20cold%20room.jpg',
  'fencing': 'https://a0.muscache.com/im/pictures/0b5913cf-74bc-4b96-b382-5682cd58b9bd.jpg',
  'farm-tour': 'https://images.squarespace-cdn.com/content/v1/617f462807184a6f59675174/0edf6911-7e4f-4604-b67c-4f234b5d82be/Singing%2BFrogs%2BFarm%2B-%2BElizabeth%2BTalking%2B-%2BPurple%2BTop.jpg',
  'farm-stay': 'https://a0.muscache.com/im/pictures/0b5913cf-74bc-4b96-b382-5682cd58b9bd.jpg',
  'picnic-pass': 'https://images.squarespace-cdn.com/content/v1/586b0be5ff7c50bb14e60c9a/1672692896048-ZJZYAUGNICCPK74FUXFE/1J4A6797.jpg?format=1000w',
  'fruit': 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSb8kYyd1BgnsWlPYURnQIp4vfOTxuisN4YEl0ycOLj-Q&s=10'
};
...
/* Inline SVG map-pin — replaces the 📍 emoji everywhere */
const PIN_SVG = '<svg class="pin-icon" viewBox="0 0 24 24" aria-hidden="true" style="width:14px;height:14px;flex-shrink:0;vertical-align:-2px;"><path fill="#e53935" d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z"/><circle fill="#fff" cx="12" cy="9" r="3"/></svg>';
...
function renderDrivers(){
 ...
 box.innerHTML=DRIVERS.map(d=>`<div class="driver-card"><div class="driver-avatar">🚗</div><div class="driver-main"><h3>${d.name} <span class="verified-badge">✓ Verified</span></h3><p>⭐ ${d.rating} · ${d.trips} deliveries · ${PIN_SVG} ${d.area}</p><p><strong>${d.vehicle}</strong> (${d.year}) · ${d.capacity}</p></div><div class="driver-action"><strong>${money(d.price)}</strong><small>starting fee</small><button class="add-cart" onclick="hireDriver('${d.id}', this)">Request driver</button></div></div>`).join('');
}
...
function livestockCard(a){
 ...
 return `<div class="product-card livestock-card"><div class="product-img"><span class="verified-badge">✓ Live listing</span><img src="${a.image}" alt="${a.title}" loading="lazy" onerror="this.onerror=null;this.src='${fallbackImg}';"></div><div class="product-info"><h3>${a.title}</h3><div class="price">${money(a.price)} / ${a.unit}</div><p><strong>${a.species}</strong> · ${a.breed}</p><div class="product-meta"><span>${PIN_SVG} ${a.location}</span><span>${a.qty} available</span></div><p class="muted">${a.age} · ${a.weight}</p><button class="add-cart" onclick="requestLivestock('${a.id}')">Request / enquire</button></div></div>`;
}
...
function productCard(p){
 ...
 return `<div class="product-card">
   ...
   <div class="product-info">
     ...
     <div class="product-meta"><span>${PIN_SVG} ${p.location}</span><span class="stock-pill${lowStock?' low':''}">${p.stock} ${p.service?'slots':'available'}</span></div>
